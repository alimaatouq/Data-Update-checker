...
original_file = openpyxl.load_workbook("original.xlsx")
edited_file = openpyxl.load_workbook("edited.xlsx")
...
if original_file and edited_file:
    ...
    st.download_button("Download Compared File", data=comapred_file, file_name ="compared_file.xlsx")
